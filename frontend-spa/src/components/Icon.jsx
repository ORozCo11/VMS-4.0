...
const PATHS = {
  ...
  boat: (
    <>
      <path d="M2 20a5.5 5.5 0 0 0 4 1.5c1.5 0 3-1 4-1.5s2.5-1.5 4-1.5 3 1 4 1.5 2.5 1.5 4 1.5a5.5 5.5 0 0 0 4-1.5" />
      <path d="M4 20 2.5 14.5A1 1 0 0 1 3.5 13H20.5a1 1 0 0 1 1 1.5L20 20" />
      <path d="M6 13V7a1 1 0 0 1 1-1h4l6 6" />
      <path d="M11 6V2h2a2 2 0 0 1 2 2v2" />
    </>
  ),
  clipboard: (
    <>
  ...
  cloudSun: (
    <>
      <path d="M12 2v1M4.6 5.6l.7.7M2 13h1M21 13h-1M18.7 6.3l-.7.7M16.5 9.5A4.5 4.5 0 1 0 8 8" />
      <path d="M13 16a4 4 0 0 0-7.5 1.5A3 3 0 0 0 6 22h11a3 3 0 0 0 .5-5.96A4 4 0 0 0 13 16z" />
    </>
  ),
  cloudFog: (
    <>
      <path d="M16 17a4 4 0 0 0 0-8 5.5 5.5 0 0 0-10.5 1.5A3.5 3.5 0 0 0 6 17" />
      <path d="M4 20h16M7 23h12" />
    </>
  ),
  cloudRain: (
    <>
